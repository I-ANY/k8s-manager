...
import (
	...
	operationv1alpha1 "gitee.com/jay-kim/appconfig-operator/api/v1alpha1"
	"gitee.com/jay-kim/appconfig-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(operationv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "b0759340.operation.top",
